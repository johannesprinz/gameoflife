namespace Thoughtology.GameOfLife.Tests.Web.Controllers.GenerationControllerTests
{
    ...
    public class When_calculating_the_next_generation_with_reproduction : WithSubject<GenerationController>
    {
        ...
        Establish context = () =>
        {
            solitaryCell = new Cell(alive: false, neighbours: 3);
        ...
        It should_mark_the_solitary_cell_as_alive = () =>
            solitaryCell.Alive.ShouldBeTrue();
    }
}
